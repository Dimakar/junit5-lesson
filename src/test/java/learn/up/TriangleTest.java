...
@Disabled("Перенесены в параметризированные тест")
public class TriangleTest {
    ...
    public void countPerimeterInvalidTriangleWithSideEqualSumOtOtherTest() {
    ...
    @Test
    @DisplayName("Периметр невалидного треугольника со стороной большей, чем сумма двух других сторон")
    public void countPerimeterInvalidTriangleWithSideGreaterSumOtOtherTest() {
